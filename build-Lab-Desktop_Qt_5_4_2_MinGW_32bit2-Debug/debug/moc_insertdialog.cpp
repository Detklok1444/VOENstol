...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_insertDialog_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_insertDialog_t qt_meta_stringdata_insertDialog = {
    {
QT_MOC_LITERAL(0, 0, 12), // "insertDialog"
QT_MOC_LITERAL(1, 13, 12), // "acceptButton"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 13) // "acceptHandler"

    },
    "insertDialog\0acceptButton\0\0acceptHandler"
};
...
void insertDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->acceptButton(); break;
        case 1: _t->acceptHandler(); break;
        default: ;
        }
        ...
        {
            typedef void (insertDialog::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&insertDialog::acceptButton)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void insertDialog::acceptButton()
{
